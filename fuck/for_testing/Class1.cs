...
namespace fuck
{
  ...
  public class Class1 : IDisposable
  {
    ...
    /// <summary>
    /// Provides a single output, 0-input MWArrayinterface to the fuck MATLAB function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    ...
    public MWArray fuck()
    {
      return mcr.EvaluateFunction("fuck", new MWArray[]{});
    }


    /// <summary>
    /// Provides the standard 0-input MWArray interface to the fuck MATLAB function.
    /// </summary>
    /// <remarks>
    /// M-Documentation:
    /// $$I_1=R_{I_o}\left (max\left\{\gamma_{B_i} (I_o)\right\}\right), &amp;
    ...
    /// arguments.</returns>
    ///
    public MWArray[] fuck(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "fuck", new MWArray[]{});
    }
    ...
    ///
    public void fuck(int numArgsOut, ref MWArray[] argsOut, MWArray[] argsIn)
    {
      mcr.EvaluateFunction("fuck", numArgsOut, ref argsOut, argsIn);
    }
